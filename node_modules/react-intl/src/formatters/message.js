...
function formatMessage(_a, state, messageDescriptor, values) {
    ...
    intl_utils_1.invariant(!!msgId, '[React Intl] An `id` must be provided to format a message.');
    var id = String(msgId);
    var message = 
    ...
    var patchedValues = assignUniqueKeysToFormatXMLElementFnArgument(__assign(__assign({}, defaultRichTextElements), (values || {})));

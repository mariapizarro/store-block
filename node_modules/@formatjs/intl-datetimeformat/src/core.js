...
function initializeDateTimeFormat(dtf, locales, opts) {
    ...
    if (timeZone !== undefined) {
        ...
        timeZone = exports.DateTimeFormat.__defaultTimeZone;
    }
...
exports.DateTimeFormat.__defaultTimeZone =
...
exports.DateTimeFormat.__addLocaleData = function __addLocaleData() {
    ...
    for (var _a = 0, data_1 = data; _a < data_1.length; _a++) {
        ...
        var _loop_1 = function (locale) {
            try {
                var _a = intl_utils_1.unpackData(locale, datum), dateFormat = _a.dateFormat, timeFormat = _a.timeFormat, dateTimeFormat = _a.dateTimeFormat, formats_3 = _a.formats, rawData = __rest(_a, ["dateFormat", "timeFormat", "dateTimeFormat", "formats"]);
